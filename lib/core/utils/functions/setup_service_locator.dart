...
import 'package:qimam/Features/Splash/data/datasources/alert_remote_data_source.dart';
import 'package:qimam/Features/Splash/data/repositories/alert_repo_impl.dart';
import 'package:qimam/Features/Splash/domain/repositories/alert_repo.dart';
import 'package:qimam/Features/Splash/domain/use_case/alert_use_case.dart';
import 'package:qimam/Features/Splash/presentation/manger/add_alert_cubit/add_alert_cubit.dart';
import 'package:qimam/Features/Splash/presentation/manger/alert_cubit/alert_cubit.dart';
import 'package:qimam/Features/Splash/presentation/manger/show_alert_cubit/show_alert_cubit.dart';
import 'package:qimam/Features/add_location/data/repositories/locations_repo_impl.dart';
import 'package:qimam/Features/add_location/domain/repositories/locations_repo.dart';
import 'package:qimam/Features/add_location/domain/use_cases/locations_use_case.dart';
import 'package:qimam/Features/add_location/presentation/manager/add_location/add_location_cubit.dart';
import 'package:qimam/Features/add_location/presentation/manager/delete_locations_cubit/delete_locations_cubit.dart';
import 'package:qimam/Features/add_location/presentation/manager/locations_cubit/locations_cubit.dart';
import 'package:qimam/Features/add_location/presentation/manager/sites_types/sites_type_cubit.dart';
import 'package:qimam/Features/app_home/data/dat_source/finger_print/_remote_data_source/all_services_remote_data_source.dart';
import 'package:qimam/Features/app_home/presentation/manger/ads_cubit/ads_cubit.dart';
import 'package:qimam/Features/app_home/presentation/manger/ntaq_cubit/ntaq_cubit.dart';
import 'package:qimam/Features/app_home/presentation/manger/ntaq_type_cubit/ntaq_types_cubit.dart';
import 'package:qimam/Features/app_home/presentation/manger/services_cubit/services_cubit.dart';
import 'package:qimam/Features/app_home/presentation/manger/toggle_cubit.dart';
import 'package:qimam/Features/auth/register/presentation/manager/cubit/count_down_timer_cubit.dart';
import 'package:qimam/Features/auth/update_profile/data/data_sources/update_profile_remote_data_source.dart';
import 'package:qimam/Features/auth/update_profile/data/repositories/update_profile_repo_impl.dart';
import 'package:qimam/Features/auth/update_profile/domain/repositories/update_profile_repo.dart';
import 'package:qimam/Features/auth/update_profile/domain/use_cases/update_profile_use_case.dart';
import 'package:qimam/Features/auth/update_profile/presentation/manager/cubit/update_profile_cubit.dart';
import 'package:qimam/Features/auth/update_signature/data/data_sources/update_signature_remote_data_source.dart';
import 'package:qimam/Features/auth/update_signature/data/repositories/update_signature_repo_impl.dart';
import 'package:qimam/Features/auth/update_signature/domain/repositories/update_signature_repo.dart';
import 'package:qimam/Features/auth/update_signature/domain/use_cases/update_signature_use_case.dart';
import 'package:qimam/Features/auth/update_signature/presentation/manager/cubit/update_signature_cubit.dart';
import 'package:qimam/Features/ehsaeyat/data/data_sources/remote_data_source/all_ehsaeyat_remote_data_source.dart';
import 'package:qimam/Features/ehsaeyat/data/repositories/ehsaeyat_repo_impl.dart';
import 'package:qimam/Features/ehsaeyat/domain/repositories/ehsaeyat_repo.dart';
import 'package:qimam/Features/ehsaeyat/domain/use_cases/ehsaeyat_use_case.dart';
import 'package:qimam/Features/ehsaeyat/presentation/manager/ehsaeyat_cubit/ehsaeyat_cubit.dart';
import 'package:qimam/Features/ehsaeyat_table/data/data_sources/table_remote_data_source/ehsaeyat_table_data_remote_data_source.dart';
import 'package:qimam/Features/ehsaeyat_table/domain/repositories/table_repository.dart';
import 'package:qimam/Features/ehsaeyat_table/domain/use_case/table_use_case.dart';
import 'package:qimam/Features/ehsaeyat_table/presentation/manager/cubit_table_horizental/ehsaeyat_table_cubit.dart';
import 'package:qimam/Features/ehsaeyat_table/presentation/manager/cubit_table_vertical/ehsaeyat_table_data_cubit.dart';
import 'package:qimam/Features/enzarat/data/data_sources/remote_data_source/all_enzarat_remote_data_source.dart';
import 'package:qimam/Features/enzarat/data/data_sources/remote_data_source/seen_enzarat_remote_data_source.dart';
import 'package:qimam/Features/enzarat/data/repositories/ta3mem_repo_impl.dart';
import 'package:qimam/Features/enzarat/domain/repositories/enzarat_repo.dart';
import 'package:qimam/Features/enzarat/domain/use_cases/enzarat_use_case.dart';
import 'package:qimam/Features/enzarat/presentation/manager/enzarat_cubit/enzarat_cubit.dart';
import 'package:qimam/Features/enzarat/presentation/manager/seen_cubit/seen_enzarat_cubit.dart';
import 'package:qimam/Features/introduction/data/dat_source/remote_data_source/all_intro_remote_data_source.dart';
import 'package:qimam/Features/introduction/data/repository/intro_repository_implementation.dart';
import 'package:qimam/Features/introduction/domain/repository/intro_repo.dart';
import 'package:qimam/Features/introduction/domain/use_cases/intro_use_case.dart';
import 'package:qimam/Features/introduction/presentation/manger/services_cubit/intro_cubit.dart';
import 'package:qimam/Features/lwae7/data/data_sources/remote_data_source/seen_lwae7_remote_data_source.dart';
import 'package:qimam/Features/lwae7/domain/use_cases/lwae7_use_case.dart';
import 'package:qimam/Features/lwae7/presentation/manager/lwae7_cubit/lwae7_cubit.dart';
import 'package:qimam/Features/messages/my_messages/data/data_sources/remote_data_source/delete_messages_remote_data_Source.dart';
import 'package:qimam/Features/mobadarat/data/data_sources/remote_data_source/all_mobadarat_remote_data_source.dart';
import 'package:qimam/Features/mobadarat/data/data_sources/remote_data_source/delete_mobadarat_remote_data_Source.dart';
import 'package:qimam/Features/mobadarat/data/data_sources/remote_data_source/sent_mobadarat_remote_data_source.dart';
import 'package:qimam/Features/mobadarat/domain/repositories/mobadarat_repo.dart';
import 'package:qimam/Features/mobadarat/domain/use_cases/type_mobadarat_use_case.dart';
import 'package:qimam/Features/mobadarat/presentation/manager/add_mobadarat_cubit/add_mobadarat_cubit.dart';
import 'package:qimam/Features/mosalat/data/data_sources/remote_data_source/add_answer_mosalat_remote_data_source.dart';
import 'package:qimam/Features/mosalat/data/data_sources/remote_data_source/all_mosalat_remote_data_source.dart';
import 'package:qimam/Features/mosalat/data/repositories/mosalat_repo_impl.dart';
import 'package:qimam/Features/mosalat/domain/repositories/mosalat_repo.dart';
import 'package:qimam/Features/mosalat/domain/use_cases/mosalat_use_case.dart';
import 'package:qimam/Features/mosalat/presentation/manager/seen_cubit/add_mosalat_cubit.dart';
import 'package:qimam/Features/mosalat/presentation/manager/select_file/presentation/cubit/select_file_mosalat_cubit.dart';
import 'package:qimam/Features/mosalat/presentation/manager/ta3mem_cubit/mosalat_cubit.dart';
import 'package:qimam/Features/new_bsama_add_Fingerprint/data/dat_source/finger_print/_remote_data_source/new_finger_print_remote_data_source.dart';
import 'package:qimam/Features/new_bsama_add_Fingerprint/data/repository/new_finger_print_repository_implementation.dart';
import 'package:qimam/Features/new_bsama_add_Fingerprint/domain/repository/new_finger_print_repo.dart';
import 'package:qimam/Features/new_bsama_add_Fingerprint/domain/use_cases/new_finger_print_use_case.dart';
import 'package:qimam/Features/new_bsama_add_Fingerprint/presentation/manger/new_finger_print_cubit.dart';
import 'package:qimam/Features/ezen/data/data_sources/remote_data_source/all_ezen_remote_data_source.dart';
import 'package:qimam/Features/ezen/data/data_sources/remote_data_source/delete_ezen_remote_data_Source.dart';
import 'package:qimam/Features/ezen/data/data_sources/remote_data_source/egraa_ezen_remote_data_source.dart';
import 'package:qimam/Features/ezen/data/data_sources/remote_data_source/add_and-edit_ezen_remote_data_source.dart';
import 'package:qimam/Features/ezen/data/data_sources/remote_data_source/type_ezen_remote_data_source.dart';
import 'package:qimam/Features/ezen/data/repositories/type_ezen_repo_impl.dart';
import 'package:qimam/Features/ezen/domain/repositories/ezen_repo.dart';
import 'package:qimam/Features/ezen/domain/use_cases/ezen_use_case.dart';
import 'package:qimam/Features/ezen/presentation/manager/add_ezen_cubit/add_ezen_cubit.dart';
import 'package:qimam/Features/ezen/presentation/manager/all_ezen_cubit/all_ezen_cubit.dart';
import 'package:qimam/Features/ezen/presentation/manager/delete_ezen_cubit/delete_ezen_cubit.dart';
import 'package:qimam/Features/ezen/presentation/manager/egraa_ezen_cubit/egraa_ezen_cubit.dart';
import 'package:qimam/Features/ezen/presentation/manager/type_ezen_cubit/type_ezen_cubit.dart';
import 'package:qimam/Features/notification_view/data/repositories/notification_repo_impl.dart';
import 'package:qimam/Features/notification_view/domain/use_cases/notification_use_case.dart';
import 'package:qimam/Features/permission_edara/data/data_sources/remote_data_source/all_talabat_remote_data_source.dart';
import 'package:qimam/Features/permission_edara/data/data_sources/remote_data_source/delete_ezen_remote_data_Source.dart';
import 'package:qimam/Features/permission_edara/data/data_sources/remote_data_source/sent_talabat_remote_data_source.dart';
import 'package:qimam/Features/permission_edara/data/data_sources/remote_data_source/type_talabat_remote_data_source.dart';
import 'package:qimam/Features/permission_edara/data/repositories/type_talab_repo_impl.dart';
import 'package:qimam/Features/permission_edara/domain/repositories/talab_repo.dart';
import 'package:qimam/Features/permission_edara/domain/use_cases/type_ezen_use_case.dart';
import 'package:qimam/Features/permission_edara/presentation/manager/add_talabat_cubit/add_talabt_cubit.dart';
import 'package:qimam/Features/permission_edara/presentation/manager/all_talabat_cubit/all_talabat_cubit.dart';
import 'package:qimam/Features/permission_edara/presentation/manager/delete_ezen_cubit/delete_talabat_cubit.dart';
import 'package:qimam/Features/permission_edara/presentation/manager/type_talabat_cubit/type_talabat_cubit.dart';
import 'package:qimam/Features/personal_account/data/data_sources/get_profile_remote_data_source.dart';
import 'package:qimam/Features/personal_account/data/repositories/get_profile_repo_impl.dart';
import 'package:qimam/Features/personal_account/domain/repositories/get_profile_repo.dart';
import 'package:qimam/Features/personal_account/domain/use_cases/get_profile_use_case.dart';
import 'package:qimam/Features/personal_account/presentation/manager/cubit/get_profile_cubit.dart';
import 'package:qimam/Features/privacy_and_policy/data/data_sources/privacy_and_policy_remote_data_sources.dart';
import 'package:qimam/Features/privacy_and_policy/data/repositories/privacy_and_policy_repo_impl.dart';
import 'package:qimam/Features/privacy_and_policy/domain/repositories/privacy_and_policy_repo.dart';
import 'package:qimam/Features/privacy_and_policy/domain/use_cases/privacy_and_policy_use_case.dart';
import 'package:qimam/Features/privacy_and_policy/presentation/manager/cubit/privacy_and_policy_cubit.dart';
import 'package:qimam/Features/rates/data/datasources/types_rate_remote_data_source.dart';
import 'package:qimam/Features/rates/domain/repositories/rate_repo.dart';
import 'package:qimam/Features/rates/domain/usecases/rate_use_case.dart';
import 'package:qimam/Features/rates/presentation/cubit/add_taqeem_cubit/add_taqeem_cubit.dart';
import 'package:qimam/Features/rates/presentation/cubit/all_emp_taqeem_cubit/all_emp_taqeem_cubit.dart';
import 'package:qimam/Features/rates/presentation/cubit/bnod_taqeem_cubit/bnod_taqeem_cubit.dart';
import 'package:qimam/Features/rates/presentation/cubit/delete_taqeem_cubit/delete_taqeem_cubit.dart';
import 'package:qimam/Features/rates/presentation/cubit/edit_taqeem_cubit/edit_taqeem_cubit.dart';
import 'package:qimam/Features/rates/presentation/cubit/last_taqeem_cubit/last_taqeem_cubit.dart';
import 'package:qimam/Features/rates/presentation/cubit/month_cubit/month_cubit.dart';
import 'package:qimam/Features/rates/presentation/cubit/my_taqeem_cubit/my_taqeem_cubit.dart';
import 'package:qimam/Features/ta3mem/data/data_sources/remote_data_source/all_ta3mem_remote_data_source.dart';
import 'package:qimam/Features/ta3mem/data/data_sources/remote_data_source/seen_ta3mem_remote_data_source.dart';
import 'package:qimam/Features/ta3mem/data/repositories/ta3mem_repo_impl.dart';
import 'package:qimam/Features/ta3mem/domain/repositories/ta3mem_repo.dart';
import 'package:qimam/Features/ta3mem/domain/use_cases/ta3mem_use_case.dart';
import 'package:qimam/Features/ta3mem/presentation/manager/seen_cubit/seen_ta3mem_cubit.dart';
import 'package:qimam/Features/ta3mem/presentation/manager/ta3mem_cubit/ta3mem_cubit.dart';
import 'package:qimam/Features/table_location/presentation/manager/cubit/location_table_cubit.dart';
import 'package:qimam/Features/table_mohm_aml/data/data_sources/table_remote_data_source/maham_table_remote_data_source.dart';
import 'package:qimam/Features/table_mohm_aml/data/repository/table_repo_implementation.dart';
import 'package:qimam/Features/table_mohm_aml/domain/repositories/maham_table_repository.dart';
import 'package:qimam/Features/table_mohm_aml/domain/use_case/maham_table_use_case.dart';
import 'package:qimam/Features/table_mohm_aml/presentation/manager/cubit/maham_table_cubit.dart';
import 'package:qimam/Features/vacation/data/data_sources/remote_data_source/all_vacation_remote_data_source.dart';
import 'package:qimam/Features/vacation/data/data_sources/remote_data_source/delete_vacation_remote_data_Source.dart';
import 'package:qimam/Features/vacation/data/data_sources/remote_data_source/egraa_vacation_remote_data_source.dart';
import 'package:qimam/Features/vacation/data/data_sources/remote_data_source/sent_vacation_remote_data_source.dart';
import 'package:qimam/Features/vacation/data/data_sources/remote_data_source/type_vacation_remote_data_source.dart';
import 'package:qimam/Features/vacation/data/repositories/vacation_repo_impl.dart';
import 'package:qimam/Features/vacation/domain/repositories/type_vacation_repo.dart';
import 'package:qimam/Features/vacation/domain/use_cases/vacation_use_case.dart';
import 'package:qimam/Features/vacation/presentation/manager/add_vacation_cubit/add_vacation_cubit.dart';
import 'package:qimam/Features/vacation/presentation/manager/all_vacation_cubit/all_vacation_cubit.dart';
import 'package:qimam/Features/vacation/presentation/manager/delete_vacation_cubit/delete_vacation_cubit.dart';
import 'package:qimam/Features/vacation/presentation/manager/egraa_vacation_cubit/egraa_vaction_cubit.dart';
import 'package:qimam/Features/vacation/presentation/manager/select_file/presentation/cubit/select_file_vacation_cubit.dart';
import 'package:qimam/Features/vacation/presentation/manager/type_vacation_cubit/type_vacation_cubit.dart';
import 'package:qimam/Features/visits/data/data_sources/remote_data_source/all_visits_remote_data_source.dart';
import 'package:qimam/Features/visits/data/data_sources/remote_data_source/bnod_remote_data_source.dart';
import 'package:qimam/Features/visits/data/data_sources/remote_data_source/delete_visits_remote_data_Source.dart';
import 'package:qimam/Features/visits/data/data_sources/remote_data_source/sent_visits_remote_data_source.dart';
import 'package:qimam/Features/visits/data/data_sources/remote_data_source/teachers_remote_data_source.dart';
import 'package:qimam/Features/visits/data/repositories/visits_repo_impl.dart';
import 'package:qimam/Features/visits/domain/repositories/visits_repo.dart';
import 'package:qimam/Features/visits/domain/use_cases/type_visits_use_case.dart';
import 'package:qimam/Features/visits/presentation/manager/add_mobadarat_cubit/add_visits_cubit.dart';
import 'package:qimam/Features/visits/presentation/manager/all_bnod/all_bnod_cubit.dart';
import 'package:qimam/Features/visits/presentation/manager/all_teacher/all_teacher_cubit.dart';
import 'package:qimam/Features/visits/presentation/manager/all_visits/all_visits_cubit.dart';
import 'package:qimam/Features/visits/presentation/manager/delete_mobadarat_cubit/delete_visits_cubit.dart';
import 'package:qimam/Features/wathaek/presentation/manager/select_multi_files/select_multi_file_cubit.dart';
