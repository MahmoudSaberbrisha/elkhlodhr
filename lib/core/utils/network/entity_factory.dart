import 'package:qimam/Features/Splash/data/models/all_alert_model.dart';
import 'package:qimam/Features/Splash/data/models/show_alert_model.dart';
import 'package:qimam/Features/add_location/data/models/locations_model.dart';
import 'package:qimam/Features/add_location/data/models/sites_model.dart';
import 'package:qimam/Features/app_home/data/models/ads_model/ads_model.dart';
import 'package:qimam/Features/app_home/data/models/my_services_model.dart';
import 'package:qimam/Features/app_home/data/models/ntaq_model.dart';
import 'package:qimam/Features/app_home/data/models/ntaq_type_model.dart';
import 'package:qimam/Features/ehsaeyat/data/models/my_messages_model/ehsaeyat_model.dart';
import 'package:qimam/Features/ehsaeyat_table/data/models/table_data_model/ehsaeyat_table_data_model.dart';
import 'package:qimam/Features/enzarat/data/models/enzarat_model/my_enzarat_model.dart';
import 'package:qimam/Features/enzarat/data/models/seen_enzarat_model.dart';
import 'package:qimam/Features/introduction/data/models/my_services_model/my_intro_model.dart';
import 'package:qimam/Features/lwae7/data/models/my_messages_model/my_lwae7_model.dart';
import 'package:qimam/Features/lwae7/data/models/seen_lwae7_model.dart';
import 'package:qimam/Features/maham/data/models/maham_model.dart';
import 'package:qimam/Features/mosalat/data/models/my_messages_model/my_mosalat_model.dart';
import 'package:qimam/Features/new_bsama_add_Fingerprint/data/models/finger_print_model/new_finger_print_model.dart';
import 'package:qimam/Features/ezen/data/models/all_ezn_model.dart';
import 'package:qimam/Features/ezen/data/models/delete_and_add_ezen_model.dart';
import 'package:qimam/Features/ezen/data/models/type_ezen_model.dart';
import 'package:qimam/Features/notification_view/data/models/all_notification_model.dart';
import 'package:qimam/Features/permission_edara/data/models/all_talabat_model.dart';
import 'package:qimam/Features/permission_edara/data/models/delete_and_add_talabat_model.dart';
import 'package:qimam/Features/permission_edara/data/models/type_talab_model.dart';
import 'package:qimam/Features/privacy_and_policy/data/models/privacy_and_policy_model.dart';
import 'package:qimam/Features/rates/data/models/bnod_taqeem_model.dart';
import 'package:qimam/Features/rates/data/models/last_taqeem_model.dart';
import 'package:qimam/Features/rates/data/models/month_model.dart';
import 'package:qimam/Features/ta3mem/data/models/my_messages_model/my_ta3mem_model.dart';
import 'package:qimam/Features/table_location/data/models/table_model/location_table_model.dart';
import 'package:qimam/Features/table_mohm_aml/data/models/table_model/maham_table_model.dart';
import 'package:qimam/Features/vacation/data/models/all_vacation_model.dart';
import 'package:qimam/Features/vacation/data/models/delete_and_add_vacation_model.dart';
import 'package:qimam/Features/vacation/data/models/type_vacation_model.dart';
import 'package:qimam/Features/visits/data/models/all_visits_model.dart';
import 'package:qimam/Features/visits/data/models/bnod_model.dart';
import 'package:qimam/Features/visits/data/models/delete_and_add_visits_model.dart';
